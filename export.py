...
def main():
    # Argument parser 
    parser = argparse.ArgumentParser(description="Export FSRCNN model to ONNX format")
    
    parser.add_argument('--load_path', type=str, required=True , help="Path to the saved model checkpoint")
    parser.add_argument('--save_path', type=str, default=None, help="ex) ./model.onnx")
    ...
    model = FSRCNN(args.img_format, args.scale_factor) 
