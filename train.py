...
parser = argparse.ArgumentParser(description='FSRCNN training parameters')
...
parser.add_argument('--save_root', type=str, default="checkpoint/FSRCNN", help='Model save path')
...
model = FSRCNN(img_format=args.img_format, scale_factor=args.scale_factor).to(device)
...
for epoch in range(args.nb_epochs):
    ...
    # Save model
    torch.save(model, args.save_root + f"/FSRCNN_epoch{epoch}.pth")
